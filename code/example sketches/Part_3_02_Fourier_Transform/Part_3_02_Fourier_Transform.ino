...
AudioPlaySdWav           playSdWav1;     //xy=190.83333206176758,320.833345413208
AudioPlayMemory          playMem1;       //xy=207.4999885559082,373.3333463668823
AudioSynthWaveform       waveform1;      //xy=207.5,415.0000057220459
AudioMixer4              mixer1;         //xy=381.66666666666663,339.16666666666663
AudioOutputI2S           i2s1;           //xy=564.7618980407715,297.30952072143555
AudioAnalyzeFFT1024      fft1024_1;      //xy=567.4999771118164,384.1666831970215
...
void printNumber(float n) {
  ...
  if (n >= 0.024) {     // lower number is more precise data but gets hard to read
    Serial.print(n, 3);
    Serial.print(" ");
  } else {
