...
void loop() {
  ...
  if (chordnum == 0) {
    chord = Cmajor;         // change to any chord specified in the .h file
    Serial.println("C major");
    chordnum = 1;
  } else if (chordnum == 1) {
    chord = Gmajor;         // change to any chord specified in the .h file
    Serial.println("G major");
    chordnum = 2;
  } else if (chordnum == 2) {
    chord = Aminor;       // change to any chord specified in the .h file
    Serial.println("A minor");
    chordnum = 3;
  } else {
    chord = Eminor;       // change to any chord specified in the .h file
